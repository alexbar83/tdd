  ...
  describe 'PATCH /api/v1/questions/:id' do
    ...
    describe 'author' do
      ...
      context 'update with valid attributes' do
        before do
          patch api_path, params: { access_token: user_access_token.token, question: { body: 'New body' } },
                          headers: headers
        end
      ...
      context 'update with invalid attributes' do
        before do
          patch api_path, params: { access_token: user_access_token.token, question: { title: nil } }, headers: headers
        end
      ...
      context 'unable to edit another users question' do
        before do
          put api_path, params: { access_token: access_token.token, question: { body: 'Edit' } }, headers: headers
        end
